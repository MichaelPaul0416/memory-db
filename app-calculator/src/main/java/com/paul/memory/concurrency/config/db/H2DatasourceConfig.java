 ...
 */
@Configuration
@MapperScan(basePackages = "com.paul.memory.concurrency.dao.h2", sqlSessionTemplateRef = "h2SqlSessionTemplate")
public class H2DatasourceConfig {
    ...
    public H2Config memoryH2Config(){
        H2Config memoryH2Config = new H2Config();
        return memoryH2Config;
    }

    @Bean(name = "h2Datasource")
    public DataSource dataSource(H2Config memoryH2Config) {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("h2Datasource") DataSource dataSource) throws Exception {
        ...
        try {
            ...
            factoryBean.setMapperLocations(resolver.getResources("classpath*:mapper/h2/*.xml"));
